jQuery(document).ready(function () {
    ...
    jQuery('.redux-slides-remove').live('click', function () {
        ...
        var slideCount = jQuery(this).parents('.redux-container-kad_slides:first').find('.redux-slides-accordion-group').length;
        ...
        if (slideCount > 1) {
            ...
            jQuery(this).parents('.redux-container-kad_slides:first').find('.redux-slides-accordion-group:last').find('.redux-slides-header').text("New Slide");
        }
    });

    jQuery('.kad_redux-slides-add').click(function () {
