...
class PayUSubscriptionsRequestUtil extends CommonRequestUtil{
	...
	public static function buildSubscriptionPlan($parameters){
		...
		$subscriptionPlan->paymentAttemptsDelay = CommonRequestUtil::getParameter($parameters, PayUParameters::PLAN_ATTEMPS_DELAY);
	...
	public static function validateSubscriptionPlan($parameters){
		...
		$required = array(PayUParameters::PLAN_INTERVAL, PayUParameters::PLAN_CODE,
				...
				PayUParameters::PLAN_ATTEMPS_DELAY, PayUParameters::PLAN_DESCRIPTION,
	 ...
	 * @throws InvalidParameterException 
	 */
	public static function validateCustomerToSubscription($parameters){
